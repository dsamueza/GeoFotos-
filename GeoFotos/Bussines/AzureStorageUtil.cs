...
namespace GeoFotos.Bussines
{
    public class AzureStorageUtil
    {
        ...
        private const string AzureConnection =
            "DefaultEndpointsProtocol=https;AccountName=mardisresearch;AccountKey=vSo7zxFA7cxpnSS2XZ1VP4BzHXFQdm1XbeqMnn0Fi3/p/1X9BfDUAHOF34NJ4GGoDbxnL1Z3v1Sm0mFZQDpNrw==;EndpointSuffix=core.windows.net";
